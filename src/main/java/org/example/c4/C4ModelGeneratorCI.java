...
public class C4ModelGeneratorCI {
    ...
    /**
     * Helper method to find container key in configuration - simplified version.
     */
    private static String findContainerKeyInConfig(String containerName, Map<String, ContainerDetail> allContainers) {
        ...
        // Simple exact match strategy for CI mode
        ...
        return allContainers.keySet().iterator().next();
    }
